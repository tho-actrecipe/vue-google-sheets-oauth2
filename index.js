...
function installGoogleSheetAuthPlugin(Vue, options) {
    /* eslint-disable */
    // set config
    ...
    // Install Vue plugin
    Vue.gSheetAuth = googleSheetAuth;
    Object.defineProperties(Vue.prototype, {
        $googleSheetAuth: {
            get: function () {
                return Vue.gSheetAuth;
            },
        },
    });
    Vue.gSheetAuth.load(GoogleAuthConfig);
}

export default installGoogleSheetAuthPlugin;
